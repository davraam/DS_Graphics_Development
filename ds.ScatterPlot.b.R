...
#' The user can choose any value for n equal to or greater than the pre-specified threshold
#' used as a disclosure control for this method and lower than the number of observations
#' minus the value of this threshold. By default the value of n is set to be equal to 3 
# (we suggest n to be equal to, or bigger than, 3). Note that the function fails if the user
...
#'
#'   # Example 2: generate a combined scatter plot of the centroids of each 5 nearest seighbours
...
#' }
#' 
ds.ScatterPlot.b <- function (x=NULL, y=NULL, n=3, type="combine", datasources=NULL){
  ...
  call <- paste0("centroids2dDS.b(", x, ",", y, ",", n, ")")
